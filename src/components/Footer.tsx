      ...
      {galleryImages.map((image, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-30 flex items-center justify-center transition-all duration-300">
            <div className="w-10 h-10 bg-off-white rounded-none flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              {image.type === "image" ? (
...
const Footer = () => {
  ...
  return (
    <footer className="py-16 md:py-20 bg-off-white">
